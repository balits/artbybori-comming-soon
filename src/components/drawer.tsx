      ...
      {open &&
        <>
          <motion.div className="w-full h-full absolute z-[49] bg-black/30 top-0"
            ...
            onClick={onClose}
          />
          <motion.div className="z-50 bg-offwhite absolute inset-0 h-full w-[55vw] md:w-[35vw] pr-4 pl-6  md:pl-8 mt:pt-8 flex items-start justify-start flex-col gap-y-20"
            initial={{ x: -1000 }}
            animate={{ x: 0 }}
            exit={{ x: -1000 }}
            transition={{
